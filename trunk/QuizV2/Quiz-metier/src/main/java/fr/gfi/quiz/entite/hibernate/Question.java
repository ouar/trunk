...
public class Question  implements java.io.Serializable {
    ...
    public Question(Sujet sujet) {
        this.sujet = sujet;
    }
    public Question(Sujet sujet, String libQuestion, Date datCreation, Integer intDureeReflexion, Boolean bolUniqueReponse, String urlImage, Boolean isValid, Set<QuizzQuestion> quizzQuestions, Set<ReponseCandidat> reponseCandidats, Set<Reponse> reponses) {
       this.sujet = sujet;
