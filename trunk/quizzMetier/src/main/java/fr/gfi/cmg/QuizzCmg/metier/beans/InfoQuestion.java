...
public class InfoQuestion {
	...
	public Question getQuestionHibernate() {
		...
		// si l'utilisateur a choisi un sujet déjà parametré en base.
		...
		/*
		 * associer les réponses à une question.
		 */
	...
	/**
	 * Constitue un set des entités réponses en fct des réponses saisies par
	 * l'utilisateur.
	 * 
	 * @param listInfoReponseQuestion
	 * @return
	...
	/**
	 * Détermine si une question a plusieurs réponses ou pas.
	 * 
	 * @param lReponses
	 * @return
