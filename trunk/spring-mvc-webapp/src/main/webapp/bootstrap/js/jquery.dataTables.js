	...
	_oExt.oPagination = {
		...
		"full_numbers": {
			...
			"fnInit": function ( oSettings, nPaging, fnCallbackDraw )
			{
				...
				nFirst.setAttribute ('title', oSettings.oLanguage.oPaginate.sFirst);
				nPrevious.setAttribute ('title', oSettings.oLanguage.oPaginate.sPrevious);
				nNext.setAttribute ('title', oSettings.oLanguage.oPaginate.sNext);
				nLast.setAttribute ('title', oSettings.oLanguage.oPaginate.sLast);
...
//				}
		...
		"four_buttons" : {
			...
			fnUpdate : function(oSettings, fnCallbackDraw) {
				...
				var nStatic = [ nButtons[0], nButtons[1],
						nButtons[nButtons.length - 2],
						nButtons[nButtons.length - 1] ];
				$(nStatic)
						.removeClass(
				...
				$(nStatic)
						.removeClass(
								" first_disabled previous_disabled next_disabled last_disabled");
				if (iPages == 0) {
					nStatic[0].className += " first_disabled "
							+ oClasses.sPageButtonStaticActive;
					nStatic[1].className += " previous_disabled "
							+ oClasses.sPageButtonStaticActive;
					nStatic[2].className += " next_disabled "
							+ oClasses.sPageButtonStaticActive;
					nStatic[3].className += " last_disabled "
							+ oClasses.sPageButtonStaticActive
				} else {
					if (iCurrentPage == 1) {
						nStatic[0].className += " first_disabled "
			...
			for ( var i=0 ; i<aDom.length ; i++ )
			{
				...
				if ( cOption == '<' )
				{
					...
					if ( cNext == "'" || cNext == '"' )
					{
						...
						if ( sAttr == "H" )
						{
							sAttr = "fg-toolbar ui-toolbar  ui-corner-tl ui-corner-tr ui-helper-clearfix";//ui-widget-header
						}
						else if ( sAttr == "F" )
						{
							sAttr = "fg-toolbar ui-toolbar  ui-corner-bl ui-corner-br ui-helper-clearfix";//ui-widget-header
						}
